		   ...
		   <ul className="space-y-2 flex flex-col gap-8 font-medium">
			  ...
			  <li>
				 <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
					   ...
					   <span className="flex-1 ml-3 text-left whitespace-nowrap">Applications</span>
				 ...
				 <ul id="dropdown-example" className="hidden py-2 space-y-2">
					   <li>
						  <Link to="/AllApplication" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">All App</Link>
					   </li>
					   <li>
						  <Link to="/CreateApplication" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Create App</Link>
					   </li>
