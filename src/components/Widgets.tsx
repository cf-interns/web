...
const Widgets = () => {
	...
	const PENDING = data.filter((pending) => pending.notification_type === "AUTOMATIC")


	return (
		<div className="bg-gray-100 m-4 rounded-lg" id="Widgets">
			<div className="mx-auto w-3/4">
				<div className="flex justify-between py-5 w-full lg:space-x-2 space-y-2 lg:space-y-0 mb-2 lg:mb-4 gap-8">
						...
						<div className=" w-full border-gray-400 shadow-lg p-4 rounded-lg bg-white border-l-4">
							<div className="flex items-center">
								...
								<div className="flex flex-col justify-center">
									...
									<div className="text-lg font-bold text-gray-800">Email(s)</div>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="w-full lg:w-1/5">
						<div className=" w-full p-4 rounded-lg shadow-lg bg-white border-l-4 border-gray-400">
							<div className="flex items-center">
								...
								<div className="flex flex-col justify-center">
									<div className="text-md">{PENDING ? PENDING.length : "4444"}</div>
