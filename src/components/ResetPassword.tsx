...
const ResetPassword = () => {
 ...
 const content = isLoading ? <h1>Submitting</h1> : 
    ...
    validationSchema={Yup.object({
        ...
        confrimPassword: Yup.string().password()
        .max(25)
        .min(9)
        .minUppercase(1, 'Must contain atleast 1 uppercase letter')
        .minLowercase(1, 'Must contain atleast 1 lowercase letter')    
    ...
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
            ...
            {/* <div>
                                     ...
                                     <div>
                                         <label htmlFor="confrimPassword" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">confirmPassword</label>
                                         <Field type="confirmPassword" id="confirmPassword" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" name='confirmPassword' />
